...
set "window-status-current-format" "#[fg=$onedark_black,bg=$onedark_green,nobold,nounderscore,noitalics]#[fg=$onedark_black,bg=$onedark_green,bold] #I #[fg=$onedark_green,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_white,bg=$onedark_visual_grey,nobold] #W #[fg=$onedark_visual_grey,bg=$onedark_black,nobold,nounderscore,noitalics]"
